...
// === 엑셀 파싱 ===
const wb = XLSX.readFile(resolve('_작업소스/260903/데이터/260903_data_n.xlsx'));
...
// === 이미지 파일 매핑 ===
const imageDir = resolve('_작업소스/260903/상품이미지');
let imageFiles = [];
try {
...
const existingHtml = readFileSync(resolve('_작업소스/260903/작업용.html'), 'utf-8');
...
writeFileSync(resolve('_작업소스/260903/작업용.html'), before + newTable, 'utf-8');
